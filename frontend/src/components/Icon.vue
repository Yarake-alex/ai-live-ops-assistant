...
<script setup>
// V6 全局统一线性图标：内联 SVG（24x24、stroke=currentColor），不引入任何图标依赖。
// 用法：<Icon name="box" size="16" />；未知名回退 box。
...
const ICONS = {
  ...
  radio: '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="2.5"/>',
  sparkles: '<path d="M12 2l2.9 6.3 6.6.7-4.9 4.5 1.4 6.5L12 16.8 5.9 20.5l1.4-6.5-4.9-4.5 6.6-.7z"/>',
  chat: '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22z"/>',
  chart: '<path d="M3 3v18h18"/><path d="M8 16V8"/><path d="M13 16V5"/><path d="M18 16v-4"/>',
  ...
  bulb: '<path d="M9 18h6"/><path d="M10 21h4"/><path d="M12 3a6 6 0 0 0-4 10.5c.6.6 1 1.5 1 2.5h6c0-1 .4-1.9 1-2.5A6 6 0 0 0 12 3z"/>',
