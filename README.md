...
| V6 | 资料检索增强 + 开播准备 | 商品资料文档真实 Embedding + 本地 Chroma 语义检索（自动降级基础检索）、资料完整度评分、开播准备入口 |
| V7 | 问题洞察 + 本地快答（当前） | 商品问题记录与分类、低风险本地规则快答、商品级问题洞察接口与前端面板 |
